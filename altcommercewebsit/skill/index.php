...
<div class="uk-container uk-margin">
    ...
    <div>
        <div class="skill_outer" uk-filter="target:.js-filter">
            ...
            <ul class="uk-subnav uk-margin-medium-bottom skill" style="margin-left:auto; margin-right:auto;">
                <li class="test" uk-filter-control><button class="uk-button  skills_btn  uk-margin-small-top active">All Skills</button></li>
                <li uk-filter-control=".server"><button class="uk-button skills_btn  uk-margin-small-top">APPLICATION SERVERS</button>
                </li>
                <li uk-filter-control=".cloud"><button class="uk-button skills_btn uk-margin-small-top"> CLOUD PLATFORMS</button>
                </li>
                <li uk-filter-control=".database"><button class="uk-button skills_btn uk-margin-small-top ">DATABASE</button>
                </li>
                <li uk-filter-control=".devops"><button class="uk-button skills_btn uk-margin-small-top">Development & Operations</button>
                </li>
                <li  uk-filter-control=".commerce"><button class="uk-button skills_btn uk-margin-small-top">Digital Commerce Platform</button>
                </li>
                <li  uk-filter-control=".hybrid"><button class="uk-button skills_btn uk-margin-small-top">Hybrid Mobile App Development</button>
                </li>
                <li uk-filter-control=".lang"><button class="uk-button skills_btn uk-margin-small-top">LANGUAGES</button>
                </li>
                <li uk-filter-control=".micro"><button class="uk-button skills_btn uk-margin-small-top">Microservices</button>
                </li>
                <li uk-filter-control=".payment"><button class="uk-button skills_btn uk-margin-small-top">Payment Gateway</button>
                </li>
                <li uk-filter-control=".testing"><button class="uk-button skills_btn uk-margin-small-top">QUALITY ENGINEERING</button>
                </li>
                <li uk-filter-control=".search"><button class="uk-button skills_btn uk-margin-small-top">SEARCH</button>
                </li>
                <li uk-filter-control=".integration"><button class="uk-button skills_btn uk-margin-small-top">Third Party integration</button>
                </li>
                <li uk-filter-control=".analytics"><button class="uk-button skills_btn uk-margin-small-top">WEB ANALYTICS </button>
                </li>        
            </ul>
        
            
                <ul class="js-filter uk-child-width-1-3@s uk-text-center uk-grid-small" uk-grid uk-scrollspy="target: > li > .uk-card; cls:uk-animation-slide-bottom-medium; delay: 100;">
                    <li class="commerce">
