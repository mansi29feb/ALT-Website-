        ...
        <div class="uk-child-width-1-2@m uk-grid-small uk-child-width-1-1@s uk-padding-small" uk-grid>
            ...
            <div class ="uk-width-1-2@m">
                <div class="uk-text-center">
                        <div class="uk-h3 uk-text-left about_heading  uk-margin-small-top uk-text-bold">About the ALT Commerce</div>   
                        <div class="services_article_para uk-text-left uk-text-justify">Alt Commerce combines trusted expertise and objectivity with today’s 
                            digital commerce capabilities to help software business grow.
                            We’re committed to simplifying the software search.<br>
...
<br>
                            Alt Commerce  delivers the Oracle CX (Customer Experience) portfolio of products, including:
                                <ul>
    ...
    <div class="uk-container uk-margin-medium-bottom uk-margin-medium-top">
    <div class="uk-child-width-1-1@m uk-grid-small uk-child-width-1-1@s uk-padding-small" uk-grid>
            <div class="uk-text-left about-para uk-text-justify">We have over 10+ years of experience helping companies succeed by delivering the technology that engages customers and drives sales.
