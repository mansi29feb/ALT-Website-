...
<div id="foo"> 
    ...
    <div class="uk-container">
        ...
        <div class=" uk-grid-collapse uk-child-width-expand@s" uk-grid>
            <div class=" uk-text-center uk-margin-small uk-padding-remove-right"><span class="uk-text-capitalize ">Copyrights © <script>document.write(new Date().getFullYear())</script> All Rights Reserved by <span class="uk-text-bold" style="color:#fe9603;">ALT Digital Technologies Pvt. Ltd.</span></div>
...
<!--mobile nav end-->
    ...
    <script src="<?php echo $filePath;?>js/modernizr-custom.js" defer></script>
    <script src="<?php echo $filePath;?>js/responsivelylazy.min.js" async defer></script>
