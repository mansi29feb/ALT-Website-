...
<div class="uk-container">
            ...
            <div class="uk-child-width-1-2@s  uk-text-left uk-margin-remove-top" uk-grid uk-scrollspy="cls: uk-animation-slide-left-medium; repeat: false">
                <div class="dcx-content">
                    <div class="uk-padding  uk-margin-remove-top uk-padding-remove-top">
                            <h3 class="uk-text-bold services_article_heading">Humanising the DCX to Drive Customer Loyalty</h3>
                    ...
                    <h3 class="uk-text-bold services_article_heading">Omni-Channel Delivery</h3>
                    ...
                    <div class=" uk-child-width-1-1@s uk-padding uk-margin-remove-top uk-padding-remove-top dcx-cant">
                    <h3 class="uk-text-bold services_article_heading">We “think like a customer”</h3>
                    ...
                    <h3 class="uk-text-bold services_article_heading">Integration of Various Platforms</h3>
                ...
                <div>
                    <div class="uk-padding">
                        <div class="uk-background-contain uk-height-large uk-flex dcx-img2" uk-scrollspy="cls:uk-animation-slide-bottom-medium" style="background-image: url(<?php echo $filePath;?>images/CX.png); "></div>
                    </div>
                </div>
